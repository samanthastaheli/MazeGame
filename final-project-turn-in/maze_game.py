...
# text
title_font = pygame.font.Font('Oswald.ttf', 60)
cel_font = pygame.font.Font('Oswald.ttf', 100)


# FUNCTIONS
def player():
    player = screen.blit(playerImg, (playerX, playerY))
    return player
...
while run:
    ...
    create_maze(blue)
    create_ghost('red.png', 'orange.png', 'pink.png', 'teal.png')
